...
const ReceiptModal = (props) => {
    ...
    const {showReceiptModal, setShowReceiptModal, receipt, cartItems, getTotalPrice, cash, change, printAndProceed} = props;

    return (
        <>
            { showReceiptModal && <div className="fixed w-full h-screen left-0 top-0 z-10 flex flex-wrap justify-center content-center p-24">
